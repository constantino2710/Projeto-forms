-- Adiciona filtros por curso/escola e ordenacao por orcamento/periodo
-- as RPCs de listagem usadas por usuario, admin e superadmin.

drop function if exists public.app_list_my_projects_v2(uuid, integer, integer, text, text[]);
...
drop function if exists public.app_sa_list_all_history(uuid, integer, integer, text, text);
...
grant execute on function public.app_list_my_projects_v2(uuid, integer, integer, text, text[], text, text, text, text) to anon, authenticated;
grant execute on function public.app_list_admin_projects(uuid, integer, integer, text, text, text, text) to anon, authenticated;
grant execute on function public.app_list_admin_project_history(uuid, integer, integer, text, text, text, text) to anon, authenticated;
