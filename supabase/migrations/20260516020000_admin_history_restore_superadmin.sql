-- Restaura o acesso do superadmin a RPC app_list_admin_project_history e a
-- regra que permite ao superadmin visualizar todos os projetos decididos
-- (nao apenas os revisados por ele). Ambas as garantias existiam em
-- 20260506000010_superadmin_features.sql e foram perdidas quando a funcao
-- foi redefinida em 20260515020000 / 20260515030000.
