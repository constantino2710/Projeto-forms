-- Reaplica em produção a permissão para o superadmin acessar as RPCs de
-- listagem do admin (`app_list_admin_projects` e `app_list_admin_project_history`).
-- As migrations 20260516010000 e 20260516020000 já tinham essa correção, porém
-- bancos que não haviam recebido o `db push` continuaram com a versão antiga
-- que rejeitava superadmin com "Apenas admin pode ...". Este arquivo garante o
-- estado correto ao rodar como migration nova.
